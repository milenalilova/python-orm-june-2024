...
class RoomTypeChoises(models.TextChoices):
...
class HotelRoom(models.Model):
    ...
    room_type = models.CharField(max_length=10, choices=RoomTypeChoises)
...
class Character(models.Model):
    name = models.CharField(max_length=100)
    class_name = models.CharField(max_length=20, choices=CharacterChoices)
